...
<%
    ...
    try {
        ...
        PreparedStatement ps = con.prepareStatement("UPDATE orders SET status='Approved' WHERE order_id=?");
        ps.setInt(1, orderId);

        int updateCount = ps.executeUpdate();

        if (updateCount > 0) {
            out.println("<h2>Order Approved Successfully!</h2>");
            out.println("<p>Order ID: " + orderId + " has been approved.</p>");
        } else {
